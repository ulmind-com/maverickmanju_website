  ...
  head: () => ({
    meta: [
      ...
      { title: "Maverick Manju | Magician, Emcee & Mentalist" },
      {
        name: "description",
        content:
          "Maverick Manju — magician, emcee and mentalist. Stage magic, walk-around magic, mentalism and interactive entertainment for corporate events, weddings and celebrations.",
      },
